...
export default function Autocomplete({ myStyle, ingredientsAlreadyAdded, onChangeText, legend = true }) {
  ...
  return (
    <View style={[myStyle, { zIndex: 10000 }]}>
      ...
      <View style={{ flexDirection: 'row', zIndex: 1000 }}>
        ...
        <View style={{ width: '70%', height: 23, display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
...
const IndexTable = ({ }) => {
  return (
    <View style={{ width: 300, height: 20, display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 10 }}>
      <Text style={{ width: '30%', textAlign: 'center' }}>Ingredienti</Text>
      <Text style={{ width: '24.5%', textAlign: 'center' }}>Quantità</Text>
      <Text style={{ width: '24.5%', textAlign: 'center' }}>Volte</Text>
      <Text style={{ width: '21%', textAlign: 'center' }}>Unità</Text>
    </View>
  )
}
  ...
  return (
    <View style={{ flexDirection: 'row' }}>
      <View style={styles.tableContainer}>
        <View style={[styles.borderView, { width: '30%', borderBottomLeftRadius: recipeNumber === lastIngredient ? 5 : 0 }]}>
          <Text style={styles.tableText}>{ingredient.title}</Text>
        </View>
        <View style={[styles.borderView, { width: '24.5%' }]}>
          <Text style={styles.tableText}>{ingredient.amount}</Text>
        </View>
        <View style={[styles.borderView, { width: '24.5%' }]}>
          <Text style={styles.tableText}>{ingredient.timesAWeek}</Text>
        </View>
        <View style={[styles.borderView, { width: '21%', alignItems: 'center', justifyContent: 'space-around', flexDirection: 'row', borderRightWidth: 1, borderBottomRightRadius: recipeNumber === lastIngredient ? 5 : 0 }]}>
